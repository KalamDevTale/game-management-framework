...
#include "BPNode_EnqueueGameManagerTask.generated.h"

UCLASS(BlueprintType, Blueprintable)
class GAMEMANAGEMENTFRAMEWORKEDITOR_API UBPNode_EnqueueGameManagerTask : public UK2Node_ConstructObjectFromClass
{
    ...
    UEdGraphPin *GetShowLoadingScreenPin() const;
